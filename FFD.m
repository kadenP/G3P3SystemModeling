classdef FFD < matlab.System & matlab.system.mixin.CustomIcon
    ...
    properties (Nontunable)       
        ...
        P = 1                       % (m) duct perimeter
        L = 1                       % (m) duct length
        td = 0.05                   % (m) duct thickness
    ...
    properties (Access = protected)  
        ...
        As                          % (m2) duct surface area
        Vm                          % (m3) volume of duct material     
        ...
        A                           % (1/s) nxn state matrix
        B                           % (1/s) nx1 input matrix       
    end
...
%         end
    ...
    methods(Access = protected)
        ...
        function [Ts_out, mdot_s_out, Ts, Tm, x_] = ...
            ...
            [Ts, Tm] = iterateTemps(obj, Ts_in, obj.dt);
        ...
        function [Ts, Tm] = iterateTemps(obj, Ts_in, t)

...
//Properties
    ...
    model ParticleHeatExchanger
      ...
      Modelica.Blocks.Interfaces.RealOutput CO2OutletTemperature annotation(
        Placement(visible = true, transformation(origin = {98, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {98, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealOutput ParticleOutletTemperature annotation(
        Placement(visible = true, transformation(origin = {-24, -96}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-24, -96}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      Modelica.Blocks.Interfaces.RealInput m_dot_CO2 annotation(
        Placement(visible = true, transformation(origin = {-24, -96}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-26, 96}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    equation
//Connections
      m_dot_s_in = ParticleInlet.m_dot;
      m_dot_s_out = -ParticleOutlet.m_dot;
...
model G3P3_System 
  ...
  Modelica.Blocks.Tables.CombiTable1Ds ParticleStorageCombiTable1Ds(tableOnFile=true, tableName="storageData", fileName=Modelica.Utilities.Files.loadResource("C:\Users\Owner\OneDrive\PhD Research\Modelica Model\storageLookup.txt"), columns={3, 4, 5}) annotation(
...
equation
  ...
  connect(HotBinDiverter.ParticleOutlet2, HotBinBypass.ParticleInlet) annotation(
        Line(points = {{20, 130}, {140, 130}, {140, 98}}));
      ...
      connect(hotStorageSink.ParticleInlet, HotBinInlet.ParticleOutlet) annotation(
        Line(points = {{10, 80}, {10, 90}}));
  connect(continuousClock.y, second2hour.u) annotation(
        Line(points = {{99, 10}, {82, 10}}, color = {0, 0, 127}));

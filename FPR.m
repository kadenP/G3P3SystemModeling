classdef FPR < matlab.System & matlab.system.mixin.CustomIcon
    ...
    properties (Nontunable) 
        ...
        mdotRef = 0                 % (kg/s) reference mass flow rate
    end
...
%         end
    ...
    methods(Access = protected)
        ...
        function [Ts_out, Ts_out_lin, mdot_s_out] = stepImpl(obj, Ts_in, Tinf, mdot_s_in, Qsolar, t)
            ...
            Ts_out_lin = stepLinTempSolution(obj, Ts_in, Qsolar/obj.Ar);
        ...
        function Ts = stepLinTempSolution(obj, Ts_in, qsolar)
            ...
            if obj.dt > 0.5
                t_ = linspace(0, obj.dt, 2*ceil(obj.dt));
                dt_ = t_(2);
            else
                t_ = obj.dt; 
                dt_ = obj.dt;

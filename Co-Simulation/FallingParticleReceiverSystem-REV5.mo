model FallingParticleReceiverSystem
  ...
  package SourceSink
    ...
    model ParticleSource
      ...
      Modelica.Blocks.Interfaces.RealInput m_dot_out annotation(
        Placement(visible = true, transformation(origin = {-56, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-56, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    Modelica.Blocks.Interfaces.RealInput T_s_out annotation(
        Placement(visible = true, transformation(origin = {-56, -20}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-44, -18}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
    equation
      T = ParticleOutlet.T;
...
//Properties
    ...
    model ParticleHeatExchanger
      ...
      Interfaces.ParticleFlow ParticleOutlet annotation(
        Placement(visible = true, transformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Interfaces.CO2Flow CO2Inlet annotation(
      ...
      Interfaces.CO2Flow CO2Outlet annotation(
        Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealOutput CO2OutletTemperature annotation(
        Placement(visible = true, transformation(origin = {100, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {98, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealOutput ParticleOutletTemperature annotation(
        Placement(visible = true, transformation(origin = {100, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-24, -96}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      Modelica.Blocks.Interfaces.RealInput m_dot_CO2 annotation(
        Placement(visible = true, transformation(origin = {-100, -62}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-26, 96}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    equation
//Connections
      m_dot_s_in = ParticleInlet.m_dot;
      m_dot_s_out = -ParticleOutlet.m_dot;
...
//Property Evaluation
    ...
    model ElectricalHeater
      ...
      Modelica.Blocks.Interfaces.RealInput Q_in annotation(
        Placement(visible = true, transformation(origin = {100, 0}, extent = {{20, -20}, {-20, 20}}, rotation = 0), iconTransformation(origin = {-56, 60}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
      FallingParticleReceiverSystem.Interfaces.ParticleFlow ParticleOutlet annotation(
        Placement(visible = true, transformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      FallingParticleReceiverSystem.Interfaces.ParticleFlow ParticleInlet annotation(
        Placement(visible = true, transformation(origin = {0, 98}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
//DNI = 950;
    ...
    model DecomposeTime
      input Real t0=0 "starting (offset) time";
      extends Icons.Clock;
...
// Days and Hours
      day := (t0 + time) / (24 * 3600);
      hour := (t0 + time) / 3600;
      day_number := integer((t0 + time) / (24 * 3600));
      hour_day := integer(((t0 + time) - day_number * 24 * 3600) / 3600);
      second_hour := integer((t0 + time) - hour_day * 3600 - day_number * 24 * 3600);
    end DecomposeTime;
  end Components;
...
model G3P3_System 
  input Real k;
  input Real h;
  input Types.Fraction DNI0;
  input Types.Fraction HX_m_dot0;
  input Types.Fraction Heater_m_dot0;
  input Real intStorage_m_dot_s_out0;
  input Real startTime "initial (offset) time";
  ...
  FallingParticleReceiverSystem.Components.WeatherData Weather annotation(
    Placement(visible = true, transformation(origin = {-42, 228}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  FallingParticleReceiverSystem.Components.BucketElevator Elevator(n = 10) annotation(
    Placement(visible = true, transformation(origin = {180, 123}, extent = {{-18, -23}, {18, 23}}, rotation = 0)));
  FallingParticleReceiverSystem.Components.ElectricalHeater ParticleHeater annotation(
    Placement(visible = true, transformation(origin = {-160, 88}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FallingParticleReceiverSystem.Components.LumpedStorageBin IntermediateStorage(A_bin = 1 * 1, T_s_0 = 888.15, T_s_out(fixed = true), V_bin = 6, h_loss = 0.1, m_s(fixed = true), m_s_0 = 1) annotation(
    Placement(visible = true, transformation(origin = {140, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FallingParticleReceiverSystem.Components.SolidSplitter HotBinDiverter annotation(
    Placement(visible = true, transformation(origin = {10, 136}, extent = {{-10, 10}, {10, -10}}, rotation = -90)));
  FallingParticleReceiverSystem.Components.SolidJunction HeatExchangerJunction annotation(
    Placement(visible = true, transformation(origin = {-160, 8}, extent = {{-10, 10}, {10, -10}}, rotation = -90)));
  FallingParticleReceiverSystem.Components.FreeFallDuct HotBinBypass(T_m(fixed = true), h_loss = 0.6, length = 10, perimeter = 0.785, thickness = 0.003) annotation(
    Placement(visible = true, transformation(origin = {140, 88}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  FallingParticleReceiverSystem.Components.FreeFallDuct HeaterDischarge(T_m(fixed = true), h_loss = 0.6, length = 10, perimeter = 0.785, thickness = 0.003) annotation(
    Placement(visible = true, transformation(origin = {-160, 50}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  FallingParticleReceiverSystem.Components.WedgeMassFlowHopper HeatExchangerHopper(n = 10) annotation(
    Placement(visible = true, transformation(origin = {-160, -64}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  FallingParticleReceiverSystem.SourceSink.CO2Source CO2Inlet annotation(
    Placement(visible = true, transformation(origin = {-184, -34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FallingParticleReceiverSystem.SourceSink.CO2Sink CO2Outlet annotation(
    Placement(visible = true, transformation(origin = {-110, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FallingParticleReceiverSystem.Components.DecomposeTime DecompTime(t0=startTime) annotation(
  ...
  FallingParticleReceiverSystem.Components.FreeFallDuct IntermediateStorageDownComer(T_m(fixed = true), h_loss = 0.6, length = 10, perimeter = 0.785, thickness = 0.003) annotation(
    Placement(visible = true, transformation(origin = {140, -32}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  ...
  Modelica.Blocks.Sources.Constant ReceiverSetPoint(k = 775 + 273.15) annotation(
    Placement(visible = true, transformation(origin = {-168, 170}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Math.Add add1(k2 = -1) annotation(
    Placement(visible = true, transformation(origin = {-118, 162}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FallingParticleReceiverSystem.SourceSink.ParticleSink hotStorageSink annotation(
        Placement(visible = true, transformation(origin = {10, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Tables.CombiTable1Ds ParticleStorageCombiTable1Ds(tableOnFile=true, tableName="storageData", fileName=Modelica.Utilities.Files.loadResource("C:\Users\Owner\OneDrive\PhD Research\Modelica Model\storageLookup_1MW_3day.txt"), columns={2, 3, 4}) annotation(
  ...
  FallingParticleReceiverSystem.SourceSink.ParticleSource HotStorageSource annotation(
        Placement(visible = true, transformation(origin = {-30, 8}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  FallingParticleReceiverSystem.Components.ElectricalHeater HotBinDischargeTrimHeater annotation(
        Placement(visible = true, transformation(origin = {-96, 8}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  FallingParticleReceiverSystem.Components.FreeFallDuct HotBinDischargeTrimHeaterOutlet annotation(
        Placement(visible = true, transformation(origin = {-128, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Blocks.Sources.Constant CO2OutletTempSetpoint(k = 710 + 273.15) annotation(
        Placement(visible = true, transformation(origin = {-116, -64}, extent = {{-8, -8}, {8, 8}}, rotation = 0)));
  Modelica.Blocks.Math.Add add(k2 = -1) annotation(
        Placement(visible = true, transformation(origin = {-79, -57}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
  Modelica.Blocks.Math.Product product annotation(
        Placement(visible = true, transformation(origin = {-45, 49}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
  Modelica.Blocks.Math.Gain HotBinHeaterGain(k = -1E5)  annotation(
        Placement(visible = true, transformation(origin = {-49, -37}, extent = {{7, -7}, {-7, 7}}, rotation = -90)));
  Modelica.Blocks.Nonlinear.Limiter HotBinHeaterLimiter(uMax = 200000, uMin = 0)  annotation(
        Placement(visible = true, transformation(origin = {-90, 40}, extent = {{-8, -8}, {8, 8}}, rotation = -90)));
  Modelica.Blocks.Nonlinear.FixedDelay fixedDelay(delayTime = 1)  annotation(
...
equation
      ...
      connect(add1.y, ReceiverPID.u_m) annotation(
        Line(points = {{-107, 162}, {-128, 162}, {-128, 200}}, color = {0, 0, 127}));
      connect(Receiver.OutletTemperature, add1.u2) annotation(
        Line(points = {{2, 184}, {-98, 184}, {-98, 156}, {-130, 156}}, color = {0, 0, 127}));
      ...
      connect(Elevator.ParticleInlet, BucketElevatorJunction.ParticleOutlet) annotation(
        Line(points = {{169, 110}, {161.2, 110}, {161.2, -180.34}, {69.2, -180.34}}));
      ...
      connect(HotBinBypass.ParticleOutlet, IntermediateStorage.ParticleInlet) annotation(
        Line(points = {{140, 78}, {140, 22}}));
      connect(HotBinDiverter.ParticleOutlet2, HotBinBypass.ParticleInlet) annotation(
        Line(points = {{20, 136}, {140, 136}, {140, 98}}));
      connect(ReceiverDownComer.ParticleOutlet, HotBinDiverter.ParticleInlet) annotation(
        Line(points = {{10, 154}, {10, 146}}));
      connect(hotStorageSink.ParticleInlet, HotBinInlet.ParticleOutlet) annotation(
        Line(points = {{10, 70}, {10, 90}}));
      connect(continuousClock.y, second2hour.u) annotation(
        Line(points = {{73, 8}, {56, 8}}, color = {0, 0, 127}));
      connect(second2hour.y, ParticleStorageCombiTable1Ds.u) annotation(
        Line(points = {{33, 8}, {18, 8}}, color = {0, 0, 127}));
      connect(ParticleStorageCombiTable1Ds.y[2], HotStorageSource.m_dot_out) annotation(
        Line(points = {{-5, 8}, {-24, 8}, {-24, 14}}, color = {0, 0, 127}));
      connect(ParticleStorageCombiTable1Ds.y[1], HotStorageSource.T_s_out) annotation(
        Line(points = {{-5, 8}, {-10.5, 8}, {-10.5, 6}, {-26, 6}}, color = {0, 0, 127}));
      connect(HotStorageSource.ParticleOutlet, HotBinDischarge.ParticleInlet) annotation(
        Line(points = {{-40, 8}, {-58, 8}}));
      connect(HotBinDiverter.ParticleOutlet1, HotBinInlet.ParticleInlet) annotation(
        Line(points = {{10, 126}, {10, 110}}));
      connect(HotBinDischarge.ParticleOutlet, HotBinDischargeTrimHeater.ParticleInlet) annotation(
        Line(points = {{-78, 8}, {-86, 8}}));
      connect(HotBinDischargeTrimHeaterOutlet.ParticleInlet, HotBinDischargeTrimHeater.ParticleOutlet) annotation(
        Line(points = {{-118, 8}, {-106, 8}}));
      connect(HotBinDischargeTrimHeaterOutlet.ParticleOutlet, HeatExchangerJunction.ParticleInlet2) annotation(
        Line(points = {{-138, 8}, {-150, 8}}));
      connect(HotBinHeaterLimiter.y, HotBinDischargeTrimHeater.Q_in) annotation(
        Line(points = {{-90, 32}, {-90, 14}}, color = {0, 0, 127}));
  connect(CO2OutletTempSetpoint.y, add.u2) annotation(
        Line(points = {{-107, -64}, {-87, -64}, {-87, -61}}, color = {0, 0, 127}));
  connect(add.y, HotBinHeaterGain.u) annotation(
        Line(points = {{-71, -57}, {-67, -57}, {-67, -45}, {-49, -45}}, color = {0, 0, 127}));
      connect(ParticleStorageCombiTable1Ds.y[2], product.u2) annotation(
        Line(points = {{-4, 8}, {-41, 8}, {-41, 41}}, color = {0, 0, 127}));
      connect(HotBinHeaterGain.y, product.u1) annotation(
        Line(points = {{-49, -29}, {-49, 41}}, color = {0, 0, 127}));
  connect(product.y, HotBinHeaterLimiter.u) annotation(
        Line(points = {{-44, 56}, {-72, 56}, {-72, 50}, {-90, 50}}, color = {0, 0, 127}));
  connect(ParticleHeatExchanger.CO2OutletTemperature, fixedDelay.u) annotation(
        Line(points = {{-150, -36}, {-118, -36}, {-118, -40}}, color = {0, 0, 127}));
  connect(fixedDelay.y, add.u1) annotation(
        Line(points = {{-104, -40}, {-88, -40}, {-88, -52}}, color = {0, 0, 127}));
    equation
      DNI = Weather.DNI;
...
//      HotBin.m_dot_s_out = HX_op * HX_m_dot;
      if DecompTime.hour_day > 2.0 and DecompTime.hour_day < 10.0 then
        HX_op = 1.0;
      else
        HX_op = 1E-10;
      end if;
// Electrical Heater Flow Rate
      if ParticleStorageCombiTable1Ds.y[2] < 0.01 then
        ParticleHeater.m_dot_s_out = Heater_m_dot;
      else
        ParticleHeater.m_dot_s_out = 0.0;
      end if;
// heater PID control
      //if abs(HotBinDischarge.m_dot_s_out) < 1E-10 then
      //  HotBinHeaterPI.y = 0;
      //end if;
      //if ReceiverBypass.m_dot_s_out < 1E-10 then
      //  RecieverBypassHeaterPI.y = 0;
      //end if;
      ParticleHeater.T_s_out = 615 + 273.15;
//Total Heat Loss
      Q_loss_components = ColdBin.Q_loss + IntermediateStorage.Q_loss + Elevator.Q_loss;
...
// Heat Exchanger Operation
      when initial() then
        HX_m_dot := 1E-10;
        Heater_m_dot := 0.1;
      elsewhen ParticleStorageCombiTable1Ds.y[3] > 10000 then
        HX_m_dot := 5.0;
      elsewhen ParticleStorageCombiTable1Ds.y[3] < 1000 then
        HX_m_dot := 1E-10;
      end when;
// Receiver Operation
      when initial() then

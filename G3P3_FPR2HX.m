...
Ts_in_HX = zeros(length(t1), 1); Ts_in_HX(:) = HX_.Ts0;
...
for i = 1:length(t1)
    ...
    if i == 1, sysData3.Ts_in_HX(1) = 600; end
    ...
    [sysData3.Ts_out_HX(i), sysData3.Tco2_out_HX(i), ...
        ...
        = step(HX_, sysData3.Ts_in_HX(i), sysData3.Tco2_in_HX(i), t1(i), 1, ...
            601, 700, sysData3.mdot_s_in_HX(i), sysData3.mdot_CO2_in_HX(i));
